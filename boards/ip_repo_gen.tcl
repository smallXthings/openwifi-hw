...
if {$FSIGHT_OPENWIFI_PHY_PROFILE eq "ow-nb-10"} {
  ...
  lappend board_def_preamble {`define OW_PROFILE_NB10_RF_C 1}
  ...
  error "Unsupported FSIGHT_OPENWIFI_PHY_PROFILE '$FSIGHT_OPENWIFI_PHY_PROFILE'. Expected ow-stock-20, ow-nb-10, ow-nb-10-timing-a, ow-nb-10-timing-b, ow-nb-10-timing-c, ow-nb-10-timing-d, ow-nb-10-timing-e, ow-nb-10-rf-a, ow-nb-10-rf-b, ow-nb-10-rf-c, or ow-nb-10-rf-d."
}
